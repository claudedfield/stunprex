    ...
    <section className="relative h-[420px] md:h-[520px] overflow-hidden">
      ...
      <div className="relative h-full container-site flex flex-col justify-center max-w-2xl">
        ...
        <p className="mt-5 text-white/85 text-lg leading-relaxed">
          The trainable component dominates outcomes. Genetics matter, but never decisively.
          The player who treats themselves as a beginner-with-potential outdevelops the one
