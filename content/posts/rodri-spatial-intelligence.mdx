...
This is not instinct. This is not talent. It is a habit trained into automaticity over years, and it is the behaviour that explains more about the midfielder Rodrigo Hernández became than any technical ability he possesses.
...
The **perceptual** side is the scanning itself: the deliberate head turns that capture information about what is around him. Not just seeing the ball, but building a picture of the whole environment: where defenders are positioned, which teammates have space, which angles are open, which are about to close. Research into elite midfielder visual behaviour (notably Geir Jordet's work on visual exploration in football) consistently finds that top performers scan more frequently and more systematically than average players. The exact numbers vary and should not be treated as precise, but the pattern is clear: top performers look away from the ball substantially more often.

The **cognitive** side is what Rodri does with that information: he models the future. Not what the pitch looks like now, but what it will look like in the moment between the pass leaving a teammate's foot and arriving at his own. He builds a picture of the coming moment before the moment exists. This is predictive modelling: one of the most trainable and most under-trained capacities in youth football.
...
Three observable patterns from UEFA Euro 2024, where Spain's campaign gave extensive televised footage of Rodri operating under high defensive pressure: specifically the quarterfinal against Germany (5 July 2024), the semifinal against France (9 July), and the final against England (14 July).
...
The most direct lesson is not about Rodri specifically. It is about where development happens. What Rodri demonstrates is that much of the work that matters occurs in the seconds before you receive the ball, not the seconds during which you have it. Many young players focus their attention on the touch. Rodri proves that the touch is downstream of the scan.
...
That sequence, scan, decide, receive, is the lesson from this breakdown that a young player can carry into any game.
...
**Full game recommendation:** Spain vs Germany, UEFA Euro 2024 quarterfinal (5 July 2024). Widely available online. Watch with one specific task: track Rodri's head turns in the ten seconds before each reception. Count them. Do not watch anything else. Do that for twenty minutes; then watch the rest of the game normally. The shift in what you see will be immediate and permanent.

*Correction, 11 September 2026: an earlier version of this article described Rodri's play in the minutes after England's equaliser in the Euro 2024 final. He had been substituted at half-time and was not on the pitch for that passage, which has been removed. The date of Spain's quarter-final against Germany has been corrected to 5 July 2024.*
