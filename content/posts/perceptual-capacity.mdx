...
StunpreX names seven sub-capacities within the Perceptual family: visual scanning, auditory perception, proprioception, spatial awareness, tactile sense, pattern recognition, and anticipation.
...
Football is a game that punishes perceptual debt. A player who receives the ball without already knowing what is around them enters every touch at a disadvantage. they must now gather information they should have gathered a moment earlier. Under pressure, that delay costs the ball. Even when it costs nothing else, it costs an opportunity. Over a career, it caps the ceiling of everything else.
...
Perceptual capacity is also the entry point to intelligent play. A player cannot communicate what they have not noticed, cannot adapt to what they have not sensed, cannot decide ahead of the game if they are still processing the present moment. Every other capacity family sits downstream of perception. This is why it anchors the framework.
...
An underdeveloped Perceptual capacity produces a different set of moments. A U16 with sound technique who has not built scanning habits plays with their eyes down in tight spaces. When they look up, it is to search, not to confirm. Under high press, this manifests as hesitation: a split second of uncertainty that closes down the options they have not yet mapped. The turn is late. The ball is lost. Observers describe it as "lacking composure." The real diagnosis is upstream.

Poor Perceptual output in a Premier League midfielder is visible as well: the player who plays the easiest available ball rather than the better one, time after time, and makes reliable short pass after reliable short pass without breaking the line. Sometimes this is tactical choice. Often it is perceptual habit: the forward pass was available, but not seen.
...
Include **[Scan-Decide-Receive (Two-Cone)](/training/scan-decide-receive-two-cone)** at the opening of the session, for about twelve to fifteen minutes as practice guidance. Focus: look before the ball arrives. Coach counts scans aloud or uses a flag prompt to reinforce the habit in game-like repetitions.

**Day 2: Individual practice.**  
About fifteen to twenty minutes of ball mastery, as practice guidance, alternating feet. Embed a perceptual layer: every third rep, the player calls out something in the environment (a colour, an object, a direction) before the touch lands. The call forces a head-up moment. This is the home version of the scanning habit.
...
**Day 6: A game, or a game-equivalent session.**  
Self-monitoring task: before the game, player sets a personal aim for scanning frequency. After the game, player estimates: did I know what was around me before most of my touches today? This is the affective and cognitive layer that closes the weekly perceptual loop.

**Day 7: Recovery, mental rehearsal.**  
About five to ten minutes of visualisation of the scanning habit in a game context, as practice guidance. Not the goal scored: the scan before the pass that made it possible.

## Core beliefs

The Perceptual family sits at the intersection of several of StunpreX's core beliefs.

**Scanning is a habit, not a gift** is the belief the Perceptual family exists to carry. The research on visual exploration in elite football is explicit: scanning frequency separates elite from average, and the habit is trainable. It is not a perceptual gift. It is built.
...
**Greatness is trained, not born** applies here in a specific way: a player who looks like a "natural reader of the game" has usually built the habit early,, through free play, through years of prompted scanning, through the thousand small look-ups that were coached or encouraged or simply happened in the environments they trained in. The reader of the game was built, not found.

**Cognitive load matters** extends the perceptual training principle: scanning under fatigue, in noisy environments, while managing motor output, while communicating. This is the overload that causes the habit to generalise. The perceptual capacity that holds under load is the one that holds in games.
