...
Deselection in youth football is common. It is common enough that a large share of the players an academy signs are released before they reach adulthood. The scale of it does not make it easier, but it matters that you know you are not in strange or exceptional territory. You are in territory that many players and many families walk through, and come out of intact.
...
Avoid the car-ride autopsy. The parent who uses the drive to analyse what went wrong, what the coach must have been thinking, or what the player should have done differently is pouring evaluation into a wound that needs air, not pressure.
...
These responses are normal. They are not evidence of fragility, immaturity, or an overattachment to football. They are evidence that the player cared about something and had it taken from them.
...
Is the player still developing? Are they still enjoying the game? Those are the questions that matter during this phase.
...
What we hold to is this: the work can continue, and where it does, a deselection is one moment in a longer story rather than the end of it. A player who keeps developing after a deselection, who treats the event as one moment in a long trajectory rather than the final verdict, is a player whose options remain open. The development brand's job is to support that work, honestly, at every stage.

Selection at any age measures something narrow. Development measures something complete. StunpreX coaches the second.

## For the parent: a few things to carry into the months ahead

You are the constant in your player's football life. Not the coach, not the academy, not the programme. You.
