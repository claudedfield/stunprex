...
*Constraints force adaptive solutions and produce technique under pressure that comfort never can.* The small space is not a difficulty to be graduated out of. It is the training mechanism. A player who can execute through the commit window inside a 6×6 metre grid, under a chasing defender, will find the 1v1 on a normal-sized pitch comparatively open. The game becomes the easier environment. That is the point.
