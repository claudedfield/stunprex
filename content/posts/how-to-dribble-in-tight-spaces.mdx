...
description: "Many 1v1s are lost to hesitation rather than to a skill gap. Here is how to train the commit window that beats defenders."
audienceLayer: "Player"
category: "Methodology"
codexAnchors:
  convictions: [20, 24, 32]
  capacities:
    primary: "Motor"
    secondary: "Cognitive"
...
The reason this breaks down in training is direct: *if training is easier than the game, the game exposes you.* A player who has spent years doing unopposed cone work and slow-build possession exercises has never been inside the commit window under real pressure. The game introduces that pressure and the player has no capacity for it, not because they lack skill, but because they have never trained the skill the moment actually requires.
...
This is exactly why tight spaces are such a productive training environment for the 1v1 dribble.

*Smaller spaces, fewer touches, uneven teams and tight time limits force the player to find new solutions, and they build technique under pressure in a way that comfortable conditions do not. The small space is not a difficulty to be graduated out of; it is the training mechanism. A player who can execute through the commit window inside a small grid, under a chasing defender, will find the 1v1 on a normal-sized pitch comparatively open. The game becomes the easier environment. That is the point.
...
**Weight-shift reading.** The commit window opens when the defender commits their weight. Reading weight-shift at close range, under time pressure, is a perceptual skill. It is built by facing defenders at close range, under time pressure, enough times that it becomes pattern recognition.

**The habit of committing.** This is perhaps the chief thing tight-space training produces. A player who has trained in compressed 1v1 scenarios many times over builds a default of decisive action. The hesitation habit, which is what comfort training produces, is replaced by a commitment habit. When the window appears, the body moves through it, because that is what the body has learned to do.

## The Constrained 1v1 to Score drill

This is the drill that trains the commit window directly.

****Setup:** A rectangle of roughly six by eight metres, a starting size to adjust to the player. One attacker, one defender. A small goal (two cones, about a metre and a half apart) at the far end of the rectangle. The attacker starts at the near end with the ball. The defender starts at the midpoint, facing the attacker.
...
****Duration:** About thirty seconds of live 1v1, about thirty seconds of rest, five rounds per player, all of it practice guidance rather than a prescription.
...
*Stage 3 (compressing further):* Reduce the rectangle by about a metre each way, adjusting to the player. The window gets smaller; the decision must be faster. This is the version that makes Stage 2 feel open.
