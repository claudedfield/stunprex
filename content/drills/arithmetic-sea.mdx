...
diagrams:
  - id: run
    pitch: small
    title: Watch a run
    caption: 'Dribble the sea; on a sum, keep dribbling, say the answer aloud, and exit the matching numbered gate. Loops.'
    entities:
      - type: zone
        id: grid
        x: 22
    ...
    animation:
      ...
      steps:
        - duration: 1000
          caption: 'Dribble the sea, head up.'
          moves:
            - id: P
              to:
                x: 130
                'y': 180
        - duration: 1000
          caption: '"Seven minus five?" — keep dribbling, solve: "Two!"'
          moves:
            - id: P
              to:
                x: 250
                'y': 200
        - duration: 800
          caption: Exit the matching gate.
          moves:
            - id: P
              to:
                x: 356
                'y': 200
        - duration: 1000
          caption: Re-enter; next question.
          moves:
            - id: P
              to:
                x: 60
