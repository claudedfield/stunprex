...
3. **Move it to surface B** (e.g. hard court): notice how the ball runs faster and truer, and adjust your touch weight and body to it. Repeat until the skill is clean again (Conviction 22).
4. **Move it to surface C** (e.g. uneven or wet): the bounce is unpredictable and the ball heavier or slower; read it and recalibrate (Conviction 25 — the early failures on the new surface are the data).
5. **Swap the ball** at one station: a different ball changes everything again; recalibrate to it (Conviction 28).
