...
diagrams:
  - id: run
    pitch: small
    title: Watch a rondo
    caption: 'One-touch 3v1: support angles ready, scan before it arrives, and move it on first time. Loops.'
    entities:
      - type: zone
        id: grid
        x: 80
    ...
    animation:
      ...
      steps:
        - duration: 700
          caption: First time — move it on before the defender arrives.
          moves:
            - id: ball
              to: A2
            - id: X
              to:
                ...
                'y': 160
        - duration: 700
          caption: One touch — scan done before it arrived.
          moves:
            - id: ball
              to: A3
            - id: X
              to:
                ...
                'y': 250
        - duration: 700
          caption: 'Keep it moving, support angles ready.'
          moves:
            - id: ball
              to: A1
            - id: X
