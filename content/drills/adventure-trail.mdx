...
diagrams:
  - id: run
    ...
    caption: 'A four-stop adventure trail on the weak foot: weave, maze, turn, finish. Loops.'
    entities:
      - type: zone
        id: grid
        x: 22
    ...
    animation:
      ...
      steps:
        - duration: 1100
          caption: Stop 1 — weave the trail on the weak foot.
          moves:
            - id: P
              to:
                x: 215
                'y': 300
        - duration: 900
          caption: Stop 2 — pick a path through the maze.
          moves:
            - id: P
              to:
                x: 185
                'y': 200
        - duration: 900
          caption: 'Stop 3 — into the turn box: stop and turn.'
          moves:
            - id: P
              to:
                x: 200
                'y': 118
        - duration: 900
          caption: Stop 4 — finish through the gate.
          moves:
            - id: ball
              to:
                x: 200
