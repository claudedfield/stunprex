...
diagrams:
  - id: run
    pitch: small
    title: Watch a rep
    caption: 'A tight indoor 1v1 on a fast surface: drive at the defender, beat them in the small space, and finish low. Loops.'
    entities:
      - type: cone
        id: g1
        x: 175
    ...
    animation:
      ...
      steps:
        - duration: 900
          caption: Drive at the defender on the fast surface.
          moves:
            - id: A
              to:
                x: 200
            ...
            - id: D
              to:
                ...
                'y': 155
        - duration: 800
          caption: Beat them in the tight space.
          moves:
            - id: A
              to:
                x: 155
            ...
            - id: D
              to:
                ...
                'y': 138
        - duration: 700
          caption: Finish low into the goal.
          moves:
            - id: ball
              to:
                x: 200
            ...
            - id: A
              to:
                ...
                'y': 95
        - duration: 900
          caption: 'Reset; futsal ball, tight grid.'
          moves:
            - id: ball
              to: A
            - id: A
