...
diagrams:
  - id: run
    pitch: small
    title: Watch a rep
    caption: 'Solo: pass into the wall, scan both shoulders as it returns, and take the first touch toward the chosen target. Loops.'
    entities:
      - type: zone
        id: wall
        x: 60
    ...
    animation:
      ...
      steps:
        - duration: 800
          caption: Pass firmly into the wall.
          moves:
            - id: ball
              to:
                x: 200
                'y': 52
        - duration: 900
          caption: Scan both shoulders as it returns.
          moves:
            - id: ball
              to:
                x: 200
                'y': 235
        - duration: 800
          caption: First touch toward the chosen target.
          moves:
            - id: ball
              to:
                x: 128
            ...
            - id: P
              to:
                ...
                'y': 255
        - duration: 900
          caption: Reset; new self-rule next rep.
          moves:
            - id: ball
              to: P
            - id: P
