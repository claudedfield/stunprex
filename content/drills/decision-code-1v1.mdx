...
difficulty: 4
maxDifficulty: 5
convictions: [7, 10, 20, 22, 23, 24, 32]
playerOperatingPrinciple: "Scan, register the constraint, decide, execute under double load"
diagrams:
  - id: run
    pitch: small
    title: Watch a rep
    caption: 'Scan and read the colour card during the scan, then attack the 1v1 under that constraint and finish. Loops.'
    entities:
      - type: cone
        id: g1
        x: 175
    ...
    animation:
      ...
      steps:
        - duration: 1100
          caption: 'Scan goal, boundaries, defender — and read the card: "RED — weak foot!"'
          moves: []
        - duration: 900
          caption: Drive at the defender.
          moves:
            - id: A
              to:
                x: 200
            ...
            - id: D
              to:
                ...
                'y': 150
        - duration: 800
          caption: Beat them — finish under the constraint.
          moves:
            - id: A
              to:
                x: 150
            ...
            - id: D
              to:
                ...
                'y': 135
        - duration: 700
          caption: Weak-foot finish through the goal.
          moves:
            - id: ball
              to:
                x: 200
            ...
            - id: A
              to:
                ...
                'y': 95
        - duration: 900
          caption: Reset; the card changes each rep.
          moves:
            - id: ball
              to: A
            - id: A
