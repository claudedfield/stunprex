...
1. Before the server plays the ball, R scans over both shoulders to locate D and the space (Conviction 5).
...
4. R executes — turning off either foot toward the open gate, or shielding and setting cleanly (Conviction 6, Conviction 4).
5. The coach names the read: *"D was on your left — you turned right into space. Perfect read."* or *"You turned into the defender — was the turn really on? What did your shoulder-check show?"* (Conviction 25.)
