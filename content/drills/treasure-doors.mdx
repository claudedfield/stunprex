...
diagrams:
  - id: run
    pitch: small
    title: Watch a round
    caption: 'The ball rolls in and the roller points to a door mid-roll — look up at both, then steer the ball through the treasure door. Loops.'
    entities:
      - type: cone
        id: dL1
        x: 120
    ...
    animation:
      ...
      steps:
        - duration: 900
          caption: The ball rolls in; look up at both doors.
          moves:
            - id: ball
              to:
                x: 200
        ...
        - duration: 700
          ...
          moves:
            - id: ball
              to: C
        - duration: 900
          caption: Steer through the treasure door — found it!
          moves:
            - id: ball
              attachedTo: C
            - id: C
              to:
                ...
                'y': 167
        - duration: 900
          caption: Reset; new door next round.
          moves:
            - id: C
              to:
                x: 200
