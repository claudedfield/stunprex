...
diagrams:
  - id: run
    pitch: small
    title: Watch a run
    caption: 'Dual-stream: a caller adds a second instruction — carry, scan, call the gate, and obey the override. Loops.'
    entities:
      - type: zone
        id: field
        x: 22
    ...
    animation:
      ...
      steps:
        - duration: 1000
          caption: Home square — scan; the caller adds a second stream.
          moves: []
        - duration: 1000
          ...
          moves:
            - id: P
              to:
                ...
                'y': 48
        - duration: 1000
          caption: Re-decide on the override; call the next gate.
          moves:
            - id: P
              to:
                x: 230
