...
diagrams:
  - id: run
    pitch: small
    title: Watch a rep
    caption: 'Indoor directional first touch: approach, the zone is called at delivery, one touch sends the ball there. Loops.'
    entities:
      - type: player
        id: S
        x: 200
          ...
          moves:
            - id: P
              to:
                ...
                'y': 235
        - duration: 800
          caption: Feed in; the zone is called at delivery — "left!"
          moves:
            - id: ball
              to: P
        - duration: 800
