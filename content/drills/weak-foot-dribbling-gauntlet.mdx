...
difficulty: 2
maxDifficulty: 5
convictions: [5, 10, 11, 21, 23, 24, 32, 35, 36, 38]
playerOperatingPrinciple: "Both feet, always"
diagrams:
  - id: run
    pitch: small
    title: Watch a run
    caption: 'Weak foot only, bottom to top: slalom, gate maze, turn box, finish strike. Strong-foot touches are counted. Loops.'
    entities:
      - type: zone
        id: grid
        x: 22
    ...
    animation:
      ...
      steps:
        - duration: 1100
          caption: Zone A — weak-foot slalom through the line.
          moves:
            - id: P
              to:
                x: 215
                'y': 300
        - duration: 900
          caption: Zone B — pick a route through the gate maze.
          moves:
            - id: P
              to:
                x: 190
                'y': 215
        - duration: 900
          caption: 'Zone C — into the turn box: stop and turn.'
          moves:
            - id: P
              to:
                x: 200
                'y': 115
        - duration: 900
          caption: Zone D — strike through the finish gate.
          moves:
            - id: ball
              to:
                x: 200
            ...
            - id: P
              to:
                ...
                'y': 70
        - duration: 900
          caption: Reset to the start; re-randomise the layout.
          moves:
            - id: ball
              to: P
            - id: P
