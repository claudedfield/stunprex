...
diagrams:
  - id: run
    pitch: small
    title: Watch a run
    caption: The gauntlet with a caller flashing a card at each zone — react and run it on the weak foot. Loops.
    entities:
      - type: zone
        id: grid
        x: 22
    ...
    animation:
      ...
      steps:
        - duration: 1100
          caption: Zone A — slalom; react to the flashed card.
          moves:
            - id: P
              to:
                x: 215
                'y': 300
        - duration: 900
          caption: 'Zone B — maze, route called on the flash.'
          moves:
            - id: P
              to:
                x: 185
                'y': 200
        - duration: 900
          caption: 'Zone C — turn box: stop and turn.'
          moves:
            - id: P
              to:
                x: 200
