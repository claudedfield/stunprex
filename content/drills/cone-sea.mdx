...
diagrams:
  - id: run
    pitch: small
    title: Watch a run
    caption: 'Enter, scan, call a gate aloud, carry through the cone sea, and exit cleanly — head up throughout. Loops.'
    entities:
      - type: zone
        id: grid
        x: 22
    ...
    animation:
      ...
      steps:
        - duration: 900
          caption: 'Enter from the west, ball moving, head up.'
          moves:
            - id: P
              to:
                x: 95
                'y': 185
        - duration: 900
          caption: Scan the field and call a gate aloud — "gate A!"
          moves:
            - id: P
              to:
                x: 150
                'y': 200
        - duration: 1000
          caption: 'Carry through the cone sea, eyes up between touches.'
          moves:
            - id: P
              to:
                x: 180
                'y': 115
        - duration: 900
          caption: Commit through the called gate and exit cleanly.
          moves:
            - id: P
              to:
                x: 200
                'y': 34
        - duration: 900
          caption: Reset — re-enter and call the next gate.
          moves:
            - id: P
              to:
                x: 40
