...
diagrams:
  - id: run
    pitch: small
    title: Watch a run
    caption: 'From the home square: scan, call a gate before arriving, carry through it, then chain to the next. Loops.'
    entities:
      - type: zone
        id: field
        x: 22
    ...
    animation:
      ...
      steps:
        - duration: 1000
          caption: 'In the home square — scan and call a gate: "orange far!"'
          moves: []
        - duration: 1000
          caption: 'Carry to the called gate, head up, ball moving.'
          moves:
            - id: P
              to:
                x: 76
          ...
          moves:
            - id: P
              to:
                ...
                'y': 48
        - duration: 1000
          caption: Scan and call the next — "blue far!" — no repeats.
          moves:
            - id: P
              to:
                x: 230
