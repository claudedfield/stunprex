...
diagrams:
  - id: run
    pitch: small
    title: Watch a run
    caption: 'Solo: dribble the sea, steer to the card station, flip a card without stopping the ball, then exit the named gate. Loops.'
    entities:
      - type: zone
        id: grid
        x: 22
    ...
    animation:
      ...
      steps:
        - duration: 1000
          caption: 'Dribble the open sea, head up, feet alternating.'
          moves:
            - id: P
              to:
                x: 170
                'y': 200
        - duration: 900
          caption: 'Steer to the card station — ball still moving — flip a card: "L!"'
          moves:
            - id: P
              to:
                x: 200
