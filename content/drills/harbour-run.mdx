...
difficulty: 1
maxDifficulty: 1
convictions: [9, 10, 11, 22, 23, 24]
playerOperatingPrinciple: "Ball mastery while aware"
diagrams:
  - id: run
    pitch: small
    title: Watch a voyage
    caption: Sail the boat through the rocky sea; on "Storm! To the harbour!" steer through the harbour gate. Loops.
    entities:
      - type: zone
        id: sea
        x: 30
    ...
    animation:
      ...
      steps:
        - duration: 1000
          caption: Sail through the rocky sea — steer around the rocks.
          moves:
            - id: C
              to:
                x: 150
                'y': 215
        - duration: 900
          caption: 'Keep dribbling, head up.'
          moves:
            - id: C
              to:
                x: 230
                'y': 155
        - duration: 900
          caption: '"Storm! To the harbour!" — sail through the gate.'
          moves:
            - id: C
              to:
                x: 200
                'y': 52
        - duration: 900
          caption: 'Safe landing — reset, back to sea.'
          moves:
            - id: C
              to:
                x: 200
