...
diagrams:
  - id: run
    pitch: small
    title: Watch a rep
    caption: 'Two-point scan, then dribble at the shadow defender, go around them, and score through the wide goal. Loops.'
    entities:
      - type: cone
        id: g1
        x: 160
    ...
    animation:
      ...
      steps:
        - duration: 1000
          caption: 'Two-point scan — goal, then defender.'
          moves: []
        - duration: 900
          caption: Dribble at the defender.
          moves:
            - id: A
              to:
                x: 200
          ...
          moves:
            ...
            - id: D
              to:
                ...
                'y': 100
        - duration: 700
          caption: Score through the wide goal.
          moves:
            - id: ball
              to:
                x: 200
            ...
            - id: A
              to:
                ...
                'y': 90
        - duration: 900
          caption: Reset; no score is announced — try again.
          moves:
            - id: ball
              to: A
            - id: A
