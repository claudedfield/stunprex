...
difficulty: 2
maxDifficulty: 5
convictions: [5, 10, 11, 21, 23, 24]
playerOperatingPrinciple: "Ball mastery first"
diagrams:
  - id: run
    pitch: small
    title: Watch a run
    caption: 'The four-zone gauntlet run with a futsal ball — slalom, maze, turn, finish, recalibrating the touch. Loops.'
    entities:
      - type: zone
        id: grid
        x: 22
    ...
    animation:
      ...
      steps:
        - duration: 1100
          caption: Zone A — slalom with the low-bounce futsal ball.
          moves:
            - id: P
              to:
                x: 215
                'y': 300
        - duration: 900
          caption: 'Zone B — maze, close control.'
          moves:
            - id: P
              to:
                x: 185
