...
diagrams:
  - id: run
    pitch: small
    title: Watch a run
    caption: 'Indoor call-the-gate field: carry, scan, call a gate before arriving, carry through, chain to the next. Loops.'
    entities:
      - type: zone
        id: field
        x: 22
    ...
    animation:
      ...
      steps:
        - duration: 1000
          caption: In the home square — scan and call a gate.
          moves: []
        - duration: 1000
          ...
          moves:
            - id: P
              to:
                ...
                'y': 48
        - duration: 1000
          caption: Scan and call the next gate.
          moves:
            - id: P
              to:
                x: 230
